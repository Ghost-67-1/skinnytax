            ...
            {data.map((item, index) => (
              <tr key={index}>
                ...
                <td>
                  ...
                  <ErrorMassage
                    visible={touched?.[index]?.account_type}
                    error={errors?.[index]?.account_type}
                  />
                </td>
                <td>
                  <input
                  ...
                  />
                  <ErrorMassage
                    visible={touched?.[index]?.approx_balance}
                    error={errors?.[index]?.approx_balance}
                  />
                </td>
              </tr>
            ))}
