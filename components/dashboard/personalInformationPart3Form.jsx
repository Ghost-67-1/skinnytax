...
const inputConfigs = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label:
          'Do you and your spouse consider all of your assets community property?',
        type: 'radio',
        // required: true,
      ...
      },
      {
        ...
        label:
          'Do you and your spouse receive any valueable gifts or inheritances after marriage?',
        type: 'radio',
        // required: true,
      ...
      },
      {
        ...
        label:
          'Do you and your spouse come into your marriage with any substantial assets?',
        type: 'radio',
        // required: true,
      ...
      },
      {
        ...
        label:
          'Do you havea pre-martial or post-martial agreement?(if yes, please bring it)',
        type: 'radio',
        // required: true,
...
function ChildForm({ handleNext, handlePrevious }) {
  ...
  useEffect(() => {
    axios.get('/api/marryForm').then((res) => {
