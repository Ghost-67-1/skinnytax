          ...
          <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex">
            ...
            >
              ...
              <p className="has-text-align-center">
                A charitable remainder trust (CRT) is a type of trust that
                provides income to the trust’s beneficiaries for a specified
                term of years or for their lifetimes. Upon the termination of
                the trust, the remainder of the trust’s assets are distributed
                ...
                <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                  ...
                  <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-2 wp-block-columns-is-layout-flex">
                    ...
                    <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                      ...
                      <p className="has-text-align-center has-small-font-size">
                        The trust sells the assets and invests the proceeds in a
                    ...
                    <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                      ...
                      <p className="has-text-align-center has-small-font-size">
                        The trust pays the beneficiaries an income stream,
                        either for a specified term of years or for their
                        lifetimes.
                      </p>
                    </div>
                    <div className="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                      ...
                      <p className="has-text-align-center has-small-font-size">
                        Upon the termination of the trust, the remaining assets
                        are distributed to one or more charitable organizations.
                      </p>
                    </div>
                    <div
                      className="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
          ...
          <div className="kb-row-layout-wrap kb-row-layout-id236_5e75c3-dd alignnone wp-block-kadence-rowlayout">
            <div className="kt-row-column-wrap kt-has-2-columns kt-row-layout-equal kt-tab-layout-inherit kt-mobile-layout-row kt-row-valign-bottom">
              ...
              <div className="wp-block-kadence-column kadence-column236_aa5c62-f2">
                <div className="kt-inside-inner-col">
                  <h2
                    className="kt-adv-heading236_2d5bac-16 wp-block-kadence-advancedheading"
                    data-kb-block="kb-adv-heading236_2d5bac-16"
                  >
                    Benefits
                  </h2>
                    ...
                    <ul className="kt-svg-icon-list product-list">
                      <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-236_6c44a2-a8">
                        ...
                        <span className="kt-svg-icon-list-text">
                          Provides income to the beneficiaries for a specified
                          term of years or for their lifetimes.
                        </span>
                      </li>
                      <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-236_a72d0c-7c">
                        ...
                        <span className="kt-svg-icon-list-text">
                          Allows the individual to make a significant charitable
                          gift and receive an income tax charitable deduction.
                        </span>
                      </li>
                      <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-236_b048c9-02">
                        ...
                        <span className="kt-svg-icon-list-text">
                          Provides an opportunity for the individual to reduce
                          estate taxes and minimize capital gains taxes.
                        </span>
                      </li>
                    </ul>
                  </div>
