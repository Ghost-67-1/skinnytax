...
import EstateTaxCalculator from '../income-tax/EstateTaxCalculator.jsx';
                ...
                <div className="kt-inside-inner-col">
                  <div className="wp-block-kadence-column kadence-column242_70f76d-20">
                    <div className="kt-inside-inner-col">
                      ...
                      >
                        If youre concerned about estate tax, there are several
                    ...
                    <div className="kt-row-column-wrap kt-has-2-columns kt-row-layout-right-golden kt-tab-layout-inherit kt-mobile-layout-row kt-row-valign-top">
                      ...
                      <div className="wp-block-kadence-column kadence-column242_84a49a-20">
                        <div className="kt-inside-inner-col">
                          ...
                          >
                            <strong>Make annual gifts:</strong> You can give up
                            to $15,000 per year to each of your children or
                            grandchildren without triggering any gift tax. By
                            doing so, you reduce the size of your estate, which
                            can lower your estate tax liability.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="kt-row-column-wrap kt-has-2-columns kt-row-layout-right-golden kt-tab-layout-inherit kt-mobile-layout-row kt-row-valign-top">
                      ...
                      <div className="wp-block-kadence-column kadence-column242_58be52-5c">
                        <div className="kt-inside-inner-col">
                          ...
                          >
                            <strong>Create a trust:</strong> Placing assets into
                            a trust can help you avoid estate tax by removing
                            them from your taxable estate. There are many
                            different types of trusts to consider, such as
                            revocable trusts, irrevocable trusts, and charitable
                            trusts.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="kt-row-column-wrap kt-has-2-columns kt-row-layout-right-golden kt-tab-layout-inherit kt-mobile-layout-row kt-row-valign-top">
                      ...
                      <div className="wp-block-kadence-column kadence-column242_af7b4f-e8">
                        <div className="kt-inside-inner-col">
                          ...
                          >
                            <strong>Use life insurance:</strong> Life insurance
                            proceeds are generally not subject to estate tax, so
                            you can use a life insurance policy to provide for
                            your heirs while reducing the size of your taxable
                            estate.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="wp-block-kadence-column kadence-column242_b641c5-89">
                        <div className="kt-inside-inner-col">
                          ...
                          >
                            ...
                            A family limited partnership allows you to transfer
                            assets to your heirs while retaining control over
                            them. By doing so, you reduce the size of your
                            taxable estate without giving up control of your
                            assets.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="wp-block-kadence-column kadence-column242_f18444-f2">
                        <div className="kt-inside-inner-col">
                          ...
                          >
                            ...
                            If you’re married, you can use the marital deduction
                            to transfer unlimited assets to your spouse
                            tax-free. This can be a powerful way to reduce your
                    ...
                    <div className="wbx__cta__content">
                      ...
                      <div className="wbx__cta__content__content">
                        <p>
                          ...
                          finance, and there are many strategies you can use to
