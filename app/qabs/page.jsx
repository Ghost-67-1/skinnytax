...
import QSBSCalculater from '../income-tax/QSBSCalculater.jsx';
            ...
            <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex">
              ...
              >
                ...
                <p className="has-text-align-center">
                  Qualified Small Business Stock (QSBS) refers to stock in a
                  qualified small business that has met certain requirements set
                  forth by the Internal Revenue Service (IRS).
                </p>
              </div>
              <div
                className="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
              ...
              <div className="wp-block-column is-vertically-aligned-top is-layout-flow wp-block-column-is-layout-flow">
                <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-2 wp-block-columns-is-layout-flex">
                  ...
                  >
                    ...
                    <hr className="wp-block-separator has-text-color has-luminous-vivid-amber-color has-alpha-channel-opacity has-luminous-vivid-amber-background-color has-background is-small-separator is-thick-separator" />
                    <p>
                    ...
                    <ul className="wp-block-list">
                      ...
                      <li>
                        The corporation must have less than $50 million in
                        assets.
                      </li>
                      <li>
                        The stock must be acquired by the taxpayer at original
                        issuance, either directly or through an underwriter.
                      </li>
                      <li>
                        The corporation must use at least 80% of its assets in
                  ...
                  >
                    ...
                    <hr className="wp-block-separator has-text-color has-luminous-vivid-amber-color has-alpha-channel-opacity has-luminous-vivid-amber-background-color has-background is-small-separator is-thick-separator" />
                    <p>
                      Holders of QSBS may be eligible for a number of tax
                      benefits, including:
                    </p>
                    <ul className="wp-block-list">
                      <li>
                        Exclusion of 100% of the gain from the sale of QSBS, up
                        to $10 million or 10 times the taxpayer&#8217;s basis in
                        the stock, whichever is greater.
                      </li>
                      <li>
                        The exclusion is available to both individuals and
                        corporations, but there are some limitations for
                        corporations.
                      </li>
                    </ul>
                  </div>
                  ...
                  >
                    ...
                    <p>
                      ...
                      limitations and restrictions to QSBS, including:
                    </p>
                    <ul className="wp-block-list">
                      <li>
                        The exclusion is only available for stock held for more
                        than five years.
                      </li>
                      <li>
                        The exclusion may be limited for corporations, depending
                        on the size and type of the corporation.
                      </li>
                      <li>
                        QSBS must be designated as such by the corporation and
                        the IRS before the exclusion can be claimed.
                      </li>
                    </ul>
                  </div>
                </div>
