                    ...
                    <div className="page-content">
                        ...
                        >
                            <div className="wp-block-column is-vertically-aligned-bottom is-layout-flow wp-block-column-is-layout-flow">
                                <h2 className="wp-block-heading has-text-align-center">Maximizing Deductions</h2>
                        ...
                        <div className="wp-block-columns are-vertically-aligned-center is-layout-flex wp-container-core-columns-is-layout-4 wp-block-columns-is-layout-flex">
                            <div className="wp-block-column is-vertically-aligned-center container is-layout-flow wp-block-column-is-layout-flow">
                                <div className="wp-block-columns are-vertically-aligned-center is-layout-flex wp-container-core-columns-is-layout-2 wp-block-columns-is-layout-flex">
                                    <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow" style={{ flexBasis: '25%' }} > </div>
                                    <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                                        style={{ flexBasis: '50% ' }}
                                    >
                                        <figure className="wp-block-image size-full">
                                            <Image width='738' height='560'
                                                src={taxAdvantageImg}
                                                alt='das'
                            ...
                            <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow">
                                <div
                                    className="wp-block-columns are-vertically-aligned-center is-layout-flex wp-container-core-columns-is-layout-3 wp-block-columns-is-layout-flex">
                                    <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow" style={{ flexBasis: '70%' }} >
                                        <h2 className="wp-block-heading">Tax-Advantaged Investment Accounts</h2>
                                        <p>Another way to reduce your income tax liability is to invest in tax-advantaged accounts, such
                                            as individual retirement accounts (IRAs) and 401(k)s. These accounts allow you to defer
                                            taxes on your investment gains until you withdraw the money in retirement.</p>
                                    </div>
                                    <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"> </div>
                                </div>
                            </div>
                        </div>

                        <div
                            className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-6 wp-block-columns-is-layout-flex">
                            <div className="wp-block-column is-vertically-aligned-center has-background is-layout-flow wp-block-column-is-layout-flow"
                                ...
                                <div
                                    className="wp-block-columns are-vertically-aligned-center container is-layout-flex wp-container-core-columns-is-layout-5 wp-block-columns-is-layout-flex">
                                    <div
                                    ...
                                    <div
                                        ...
                                        <div className="wbx__tax-calculator is-income_tax">
                                            ...
                                            <div className='wbx__tax-calculator__form'> <label for='grossIncome'>Enter your taxable
                                                income:</label> <input id='grossIncome' type='number' />
                                                <button id='calculateButton' className='wbx__tax-calculator__form__button'>Calculate Tax</button></div>
                                        </div>
                                    </div>
                                </div>
                                <div style={{ height: 50 }} aria-hidden='true' className='wp-block-spacer'></div>
