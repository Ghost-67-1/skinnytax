...
import CarriedInterestCalculator from '../income-tax/CarriedInterestCalculator.jsx';
              ...
              <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex">
                ...
                >
                  ...
                  <p className="has-text-align-center">
                    If you’re looking to minimize your taxes and avoid carrying
                    them over to the next year, there are several strategies you
                    can use. Here are some tips:
                  </p>
                </div>
                <div
                  className="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                        ...
                        <ul className="kt-svg-icon-list">
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_23d367-3e">
                            ...
                            <span className="kt-svg-icon-list-text">
                              ...
                              <br />
                              Contributing to retirement accounts like 401(k)s
                              and IRAs can help reduce your taxable income. This
                              can help you avoid carrying over taxes to the next
                              year.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_18bb8e-d8">
                            ...
                            <span className="kt-svg-icon-list-text">
                              ...
                              <br />
                              Make sure you’re taking advantage of all the tax
                              credits and deductions available to you. This can
                              include things like the Earned Income Tax Credit,
                              the Child Tax Credit, and deductions for things
                              like charitable donations and mortgage interest.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_dae2db-f0">
                            ...
                            <span className="kt-svg-icon-list-text">
                              ...
                              <br />
                              If you’re a business owner, make sure you’re
                              maximizing your business expenses. This can
                              include things like office supplies, travel
                              expenses, and equipment purchases. By reducing
                              your taxable income, you can avoid carrying over
                              taxes to the next year.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_f24aa2-36">
                            ...
                            <span className="kt-svg-icon-list-text">
                              <strong>4. Consider Tax-Loss Harvesting</strong>
                              <br />
                              If you have investments that have lost value, you
                              can consider selling them to offset any gains you
                              may have realized during the year. This can help
                              you reduce your taxable income and avoid carrying
                              over taxes to the next year.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_019a26-ab">
                            ...
                            <span className="kt-svg-icon-list-text">
                              <strong>5. Plan Your Charitable Giving</strong>
                              <br />
                              If you plan to make charitable donations, consider
                              doing so at the end of the year. This can help you
                              maximize your deductions and reduce your taxable
                              income.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_e67df3-65">
                            ...
                            <span className="kt-svg-icon-list-text">
                              ...
                              <br />
                              If you’re unsure about how to best minimize your
                              taxes and avoid carrying them over to the next
                              year, contact us today. We can provide
                              personalized advice and help you make the most of
                              your tax situation.
                            </span>
                          </li>
                          <li className="wp-block-kadence-listitem kt-svg-icon-list-item-wrap kt-svg-icon-list-item-244_83bc8c-8d">
                            ...
                            <span className="kt-svg-icon-list-text">
                              ...
                              <br />
                              By following these tax planning strategies, you
                              can reduce your tax bill and avoid carrying taxes
                    ...
                    <div className="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow">
                      <div className="wbx__tax-calculator is-carried_interest">
                        ...
                        <div className="wbx__tax-calculator__form">
                          ...
                          <label htmlFor="carried_interestRate">
                            Tax Rate (%):
                          </label>
